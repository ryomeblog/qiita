package com.example.tmpSpringBoot.controller;
...
public class BaseController {
     ...
     * @return レスポンス
     */
    @ExceptionHandler(TmpSpringBootRuntimeException.class)
    protected ResponseEntity<?> handleException(TmpSpringBootRuntimeException e) {
